...
namespace ConsoleApplicationBrightStarDBTest 
{
    public partial class MyEntityContext : BrightstarEntityContext {
    	...
    	static MyEntityContext() 
    	{
    		...
    		provider.AddMappingsForType(TypeMappings, typeof(ConsoleApplicationBrightStarDBTest.IActor));
    		TypeMappings.AddImplMapping<ConsoleApplicationBrightStarDBTest.IActor, ConsoleApplicationBrightStarDBTest.Actor>();
    		provider.AddMappingsForType(TypeMappings, typeof(ConsoleApplicationBrightStarDBTest.IFilm));
    		TypeMappings.AddImplMapping<ConsoleApplicationBrightStarDBTest.IFilm, ConsoleApplicationBrightStarDBTest.Film>();
    	}
    	...
    	{
    		Actors = 	new BrightstarEntitySet<ConsoleApplicationBrightStarDBTest.IActor>(this);
    		Films = 	new BrightstarEntitySet<ConsoleApplicationBrightStarDBTest.IFilm>(this);
    	}
    	
    	internal IEntitySet<ConsoleApplicationBrightStarDBTest.IActor> Actors
    	{
    		get; private set;
    	}
    	
    	internal IEntitySet<ConsoleApplicationBrightStarDBTest.IFilm> Films
    	{
    		get; private set;
    	}
...
namespace ConsoleApplicationBrightStarDBTest 
{
    ...
    internal partial class Actor : BrightstarEntityObject, IActor 
    {
    	public Actor(BrightstarEntityContext context, IDataObject dataObject) : base(context, dataObject) { }
    	public Actor() : base() { }
    	#region Implementation of ConsoleApplicationBrightStarDBTest.IActor
    	...
    	public System.Collections.Generic.ICollection<ConsoleApplicationBrightStarDBTest.IFilm> Films
    	{
    		get { return GetRelatedObjects<ConsoleApplicationBrightStarDBTest.IFilm>("Films"); }
...
namespace ConsoleApplicationBrightStarDBTest 
{
    ...
    internal partial class Film : BrightstarEntityObject, IFilm 
    {
    	public Film(BrightstarEntityContext context, IDataObject dataObject) : base(context, dataObject) { }
    	public Film() : base() { }
    	#region Implementation of ConsoleApplicationBrightStarDBTest.IFilm
    	...
    	public System.Collections.Generic.ICollection<ConsoleApplicationBrightStarDBTest.IActor> Actors
    	{
    		get { return GetRelatedObjects<ConsoleApplicationBrightStarDBTest.IActor>("Actors"); }
